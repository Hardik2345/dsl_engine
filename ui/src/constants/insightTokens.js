export const INSIGHT_BASE_TOKENS = [
  ...
  'parent_value',
  'evidence_path',
  'evidence_path_labels',
  'top1_dimension',
  'top1_dimension_label',
  'top1_value',
  'top1_parent_dimension',
  'top1_parent_dimension_label',
  'top1_parent_value',
  'top1_path',
  'top1_path_labels',
  ...
  'top2_value',
  'top2_parent_dimension',
  'top2_parent_dimension_label',
  'top2_parent_value',
  'top2_path',
  'top2_path_labels',
  ...
  'top3_value',
  'top3_parent_dimension',
  'top3_parent_dimension_label',
  'top3_parent_value',
  'top3_path',
  'top3_path_labels',
  ...
  'top4_value',
  'top4_parent_dimension',
  'top4_parent_dimension_label',
  'top4_parent_value',
  'top4_path',
  'top4_path_labels',
